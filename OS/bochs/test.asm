...
print_result:
    ...
    jmp print_result_true_val
    print_result_neg:
        call print_neg
        jmp print_result_true_val
    print_result_true_val:
        mov rdx, 0              ; 指针
        ; lea rsi, [opr_mul_result]
        mov ax, word[rcx]
        mov word[counter],ax
    ...
    print_result_push:
        ...
        inc rdx
        cmp rdx, r15
        jl print_result_push
        
        jmp print_result_pop
    ...
    print_result_pop:
        ...
        dec rdx
        cmp rdx, 0
        jne print_result_pop
        call println
        jmp print_result_ret
    print_result_ret:
        pop r15
        pop rsi
        pop rcx
